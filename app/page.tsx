  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        />
        {/* Yelp Link Section after Testimonials - Improved and better aligned */}
        <div className="flex justify-center items-center my-10 px-4">
          <a
            ...
            className="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-[#d32323] to-[#b80000] hover:from-[#b80000] hover:to-[#d32323] text-white font-bold rounded-full shadow-lg transition-all duration-300 text-base ring-2 ring-white/10 focus:outline-none focus:ring-4 focus:ring-red-400 transform hover:-translate-y-1"
